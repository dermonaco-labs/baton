...
next_phase: plan
next_owner: speckit-plan
status: ready
model_role: planning
suggested_model: null
summary: Completed clarify in the feature lane.
read_first:
...
entry_checked: []
exit_criteria:
  - id: no-needs-clarification:spec.md
    met: true
